 ...
 * thước gói, độ dài file. Chạy TUẦN TỰ và dừng ở bước hỏng đầu tiên, vì bước sau
 * đọc kết quả bước trước (đo kích thước gói cần bản dựng) và vì một trang log
 * toàn lỗi từ sáu bước cùng lúc thì không ai đọc.
 *
...
/** Sáu bước, đúng thứ tự phụ thuộc. */
const STEPS = [
  {
    name: 'typecheck',
